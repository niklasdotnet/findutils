...
#if !defined NAN || 0 || (defined __FreeBSD__ && __FreeBSD__ < 8) || defined _AIX || defined __MINGW32__
...
/* Write x as
   ...
   where
     ...
     If x is infinite or NaN: mantissa = x, exp unspecified.
   Store exp in *EXPPTR and return mantissa.  */
#if IN_FINDUTILS_GNULIB_TESTS && 0
# if !(defined __cplusplus && defined GNULIB_NAMESPACE)
#  undef frexpl
...
# endif
#endif
#if IN_FINDUTILS_GNULIB_TESTS && !(0 && !1)
# if __GLIBC__ >= 2
_GL_CXXALIASWARN (frexpl);
# endif
#endif
#if !IN_FINDUTILS_GNULIB_TESTS && defined GNULIB_POSIXCHECK
...
#if 0 || IN_FINDUTILS_GNULIB_TESTS
# if (1 \
