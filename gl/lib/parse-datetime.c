...
{
       0,   607,   607,   608,   612,   620,   622,   626,   631,   636,
     641,   646,   651,   656,   661,   665,   669,   676,   680,   684,
     689,   694,   699,   703,   708,   713,   720,   722,   726,   751,
     753,   763,   765,   767,   772,   777,   780,   782,   787,   792,
     797,   803,   812,   817,   850,   858,   866,   871,   877,   882,
     888,   892,   902,   904,   906,   911,   913,   915,   917,   919,
     921,   923,   926,   929,   931,   933,   935,   937,   939,   941,
     943,   945,   947,   949,   951,   953,   957,   959,   961,   964,
     966,   968,   973,   977,   977,   980,   981,   987,   988,   994,
     999,  1010,  1011
};
#endif
...
#line 1914 "parse-datetime.c"
    break;

  case 15: /* item: number  */
#line 666 "parse-datetime.y"
      {
        debug_print_current_time (_("number"), pc);
      }
#line 1922 "parse-datetime.c"
    break;
...
#line 685 "parse-datetime.y"
      {
        set_hhmmss (pc, (yyvsp[-1].textintval).value, 0, 0, 0);
        pc->meridian = (yyvsp[0].intval);
      }
#line 1939 "parse-datetime.c"
    break;
...
#line 1957 "parse-datetime.c"
    break;

  case 23: /* iso_8601_time: tUNUMBER zone_offset  */
#line 704 "parse-datetime.y"
      {
        set_hhmmss (pc, (yyvsp[-1].textintval).value, 0, 0, 0);
        pc->meridian = MER24;
      }
...
#line 2008 "parse-datetime.c"
    break;

  case 31: /* zone: tZONE  */
#line 764 "parse-datetime.y"
      { pc->time_zone = (yyvsp[0].intval); }
#line 2014 "parse-datetime.c"
    break;
...
#line 2057 "parse-datetime.c"
  ...
  case 38: /* day: tDAY  */
#line 788 "parse-datetime.y"
      {
        pc->day_ordinal = 0;
        pc->day_number = (yyvsp[0].intval);
      }
#line 2066 "parse-datetime.c"
    break;

  case 39: /* day: tDAY ','  */
#line 793 "parse-datetime.y"
      {
        pc->day_ordinal = 0;
...
#line 2095 "parse-datetime.c"
    break;

  case 42: /* date: tUNUMBER '/' tUNUMBER  */
#line 813 "parse-datetime.y"
      {
        pc->month = (yyvsp[-2].textintval).value;
        pc->day = (yyvsp[0].textintval).value;
      }
#line 2104 "parse-datetime.c"
    break;

  case 43: /* date: tUNUMBER '/' tUNUMBER '/' tUNUMBER  */
#line 818 "parse-datetime.y"
      {
...
#line 2220 "parse-datetime.c"
    break;

  case 53: /* rel: relunit  */
#line 905 "parse-datetime.y"
      { if (! apply_relative_time (pc, (yyvsp[0].rel), 1)) YYABORT; }
#line 2226 "parse-datetime.c"
    break;

  case 54: /* rel: dayshift  */
#line 907 "parse-datetime.y"
      { if (! apply_relative_time (pc, (yyvsp[0].rel), 1)) YYABORT; }
#line 2232 "parse-datetime.c"
    break;
...
#line 2428 "parse-datetime.c"
    break;

  case 91: /* o_colon_minutes: %empty  */
#line 1010 "parse-datetime.y"
      { (yyval.intval) = -1; }
#line 2434 "parse-datetime.c"
    break;
